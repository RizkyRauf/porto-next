...
const ServiceCard =  ({num,title}:Props) => {
    ...
    return (
        <div className="bg-black custom__service z-[100] relative transform rounded-2xl text-center p-6 shadow-md">
            <IconComponent className="w-[5rem] relative z-[1] mx-auto h-[5rem] text-blue-400" />
            <h1 className="text-[25px] relative z-[1] text-white mt-[1rem]">
                {title}
            </h1>
            <p className="text-white tex-[15px] opacity-60 mt-[0.8rem]">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Neque fugit rem dolore eaque quaerat cum, 
                quasi, ut commodi illo exercitationem quibusdam? Eos et qui dolorem illo amet tenetur iusto eius.
            </p>
